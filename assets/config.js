 ...
 * Edit the values below. Every page reads from this object.
...
window.SITE_CONFIG = {
  ...
  // Paste a Google Maps embed URL (the 'src' from the embed iframe). Leave blank to show a styled placeholder.
  googleMapsEmbed: ""
};
